    ...
    return (
        <div className="grid grid-cols-1 sm:grid-cols-2 w-auto bg-black z-0 mt-12 lg:mt-40 h-full gap-y-24 sm:gap-y-0">
            <div className="flex flex-col items-center justify-center gap-y-4">
                <img src={pate} alt="Pate" className="w-[80%] h-[80%] object-cover rounded-lg md:mt-20"></img>
            ...
            <div className="flex flex-col items-center justify-center gap-y-4 md:mt-20">
