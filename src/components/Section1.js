...
const Section1 = () => {
    return (
        <div className="relative flex flex-col items-center justify-center h-screen w-full z-0 mt-16 md:mt-0">
            ...
            <img src={Pointille} alt="pointillé" className="absolute left-0 object-cover w-[90%] h-[20%] md:h-[40%]    " />
            <div className="absolute left-8 md:left-16 flex flex-col items-start justify-center px-4">
                <h1 className="font-bold text-white text-3xl md:text-4xl text-start mb-4 w-[80%] md:w-full ">BIENVENUE DANS VOTRE PAROISSE !</h1>
